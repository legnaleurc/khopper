...
CONFIG( debug, debug|release ) {
	...
	unix:LIBS  += -L$${ROOT_PATH}/build/debug -lk_core -L$${ROOT_PATH}/build/debug/plugins -lklp_default
	win32:LIBS += -L$${ROOT_PATH}/build/debug -lk_core0 -L$${ROOT_PATH}/tmp/obj/debug -lklp_default -lloki_D
} else {
	DESTDIR     = $${ROOT_PATH}/build/release/plugins
	OBJECTS_DIR = $${ROOT_PATH}/tmp/obj/release
	DEFINES    += QT_NO_DEBUG_OUTPUT

	unix:LIBS  += -L$${ROOT_PATH}/build/release -lk_core -L$${ROOT_PATH}/build/release/plugins -lklp_default
	win32:LIBS += -L$${ROOT_PATH}/build/release -lk_core0 -L$${ROOT_PATH}/tmp/obj/release -lklp_default -lloki
